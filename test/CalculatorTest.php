...
class CalculatorTest extends \PHPUnit\Framework\TestCase
{
     ...
     */
    public function testCalculate(Subject $subject, int $omocodiaLevel, string $expectedCodiceFiscale): void
    {
     ...
     */
    public function testCalculateAllPossibilities(Subject $subject, array $expected): void
    {
        $calculator = new Calculator($subject);
     ...
     */
    public static function calculateAllPossibilitiesProvider(): array
    {
        return [
          [
            new Subject(
